...
public final class insertconfirm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(!userdata.getName().equals("")){ 
      ...
      out.write("<br>\n");
      out.write("        生年月日:");
      out.print( userdata.getYear()+"年"+userdata.getMonth()+"月"+userdata.getDay()+"日");
      out.write("<br>\n");
      out.write("        種別:");
      out.print( userdata.getType());
      out.write("<br>\n");
      out.write("        電話番号:");
      out.print( userdata.getTell());
      out.write("<br>\n");
      out.write("        自己紹介:");
      out.print( userdata.getComment());
      out.write("<br>\n");
      out.write("        上記の内容で登録します。よろしいですか？\n");
      out.write("        <form action=\"insertresult\" method=\"POST\">\n");
      out.write("            <input type=\"hidden\" name=\"ac\" value=\"ｓ\">\n");
