...
public class InsertConfirm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            //JavaBeansオブジェクトに格納していく
            UserDataBeans userdata = new UserDataBeans();
            userdata.setName((String)request.getParameter("name"));
            userdata.setYear((String)request.getParameter("year"));
            userdata.setMonth((String)request.getParameter("month"));
            userdata.setDay((String)request.getParameter("day"));
            userdata.setType((String)request.getParameter("type"));
